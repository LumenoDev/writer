    ...
    <div class="writer flex flex-col"
        ...
        <div class="toolbar bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-none flex px-2"
            ...
            <div class="toolbar-left flex justify-start"
                ...
                <!-- Divider -->
                <div class="toolbar-divider border-l border-gray-300/70 dark:border-gray-600 mx-3"></div>
            ...
            <div class="toolbar-right flex justify-end">
                ...
                <!-- Divider -->
                <div v-if="editing"
                     class="toolbar-divider border-l border-gray-300/70 dark:border-gray-600 mx-3">
                </div>
